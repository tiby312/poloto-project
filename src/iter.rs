...
pub trait PlotIterator:Iterator+Sized{
    ...
    fn twice_iter(self)->NoBufferIter<Self> where Self:Clone{
        let sec=self.clone();
        NoBufferIter{
            inner:self,
            inner2:sec
...
impl<I:Iterator> DoubleIter for BufferIter<I> where I::Item:Copy{
    type Next=std::vec::IntoIter<I::Item>;
    fn finish_first(self)->Self::Next{
        self.buffer.into_iter()
    }
}
impl<I:Iterator> Iterator for BufferIter<I> where I::Item:Copy{
    type Item=I::Item;
...
impl<I:Iterator> DoubleIter for NoBufferIter<I> where I::Item:Copy{
    type Next=I;
    fn finish_first(self)->Self::Next{
        self.inner2
    }
...
impl<I:Iterator> Iterator for NoBufferIter<I> where I::Item:Copy{
    type Item=I::Item;
    fn next(&mut self)->Option<Self::Item>{
        self.inner.next()
    }
